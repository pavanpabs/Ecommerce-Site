...
<script>
        ...
        $(document).on('click', '#addToCart', function(){
            ...
            if(i==1){
               var productId=$('#prd').val();
                var qty=$('#sst').val();
                var userId='<?=$userId?>';
                $(document).load("ajax/addToCart.php",{
                prdId:productId,pQty:qty,user:userId
          });
    ...
    <div class="toast-body">
        <strong class="" style="font-size:20px;">Your order has aded to the <a href="cart.php">CART</a> Successfully! </strong>
    </div>
    </div>

    <div class="toast m-5 alert alert-success shadow " id="myToast1" style="position: fixed; top:0; right: 0;z-index:10000" data-delay="5000">
         <div class="toast-header">
      <img src="img/bell.png" width="20px" class="rounded mr-2" alt="...">
      <strong class="mr-auto"> </strong>
      <button type="button" class="ml-2 mb-1 close" data-dismiss="toast" aria-label="Close">
    ...
    <div class="toast-body">
        <strong class="" style="font-size:20px;">This item is already in the <a href="cart.php">CART</a>! </strong>
    </div>
    </div>
			...
			<div class="row s_product_inner">
              ...
              <button onclick="var result = document.getElementById('sst'); var sst = result.value; if( !isNaN( sst )) result.value++;return false;"
				...
				<button onclick="var result = document.getElementById('sst'); var sst = result.value; if( !isNaN( sst ) &amp&amp); sst > 0 ; result.value--;return false;"
						...
						<button type="submit" id="addToCart" class="button primary-btn" >Add to Cart</button> 
							...
							<div class="review_box">
								...
								<form class="row contact_form" action="contact_process.php" method="post" id="contactForm" novalidate="novalidate">
									...
									<div class="col-md-12 text-right">
										<button type="submit" name="submitToCart" class="btn primary-btn">Submit Now</button>
									</div>
								</form>
							</div>
						</div>
